...
<asp:Button ID="Button2" runat="server" Text="查询C_of_A/Station_Licence" 
        onclick="Button2_Click" Width="200px" />
<asp:Button ID="Button3" runat="server" Text="查询Radio_Licence/CAAC ASL" onclick="Button3_Click" 
        style="width: 200px" />
    <br />
