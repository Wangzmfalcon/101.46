<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Finding_Control.aspx.cs" Inherits="Home" %>
...
<div id="biaoti" style=" font-size:20px; text-align:center; color:Red">Finding 
    Control<br />
    <br />
    </div>
<div style="width:800px; height=150px;font-size:14px; float:left;">
<p>上传数据，点击Browse选择要上传的数据，点击上传按钮上传数据。</p>
...
<div style="width:800px; height=150px;font-size:14px; float:left;">
<p>输入对应的查询信息</p>
    CAR_No<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
    Audit_Title<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>Div<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
    <br />
<asp:Button ID="Button2" runat="server" Text="查询Final_Issue_Date" 
        onclick="Button2_Click" Width="180px" />
<asp:Button ID="Button3" runat="server" Text="查询Final_Due_Date" 
        onclick="Button3_Click" Width="180px" />
    <br />
