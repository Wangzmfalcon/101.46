...
<p><span class="style2">To</span>  输入接收提醒人员的E-mail，用分号分隔开,只允许添加公司邮箱即以@airmacau.com.mo结尾的邮箱</p>
<p>例如:example1@airmacau.com.mo;example2@airmacau.com.mo</p>
 <asp:TextBox ID="TextBox1" runat="server" Height="128px" Width="498px" TextMode=MultiLine></asp:TextBox>
    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="OK" />
</div>

<div style="width:800px; height=150px;font-size:14px; float:left;">
<p><span class="style2"><strong>CC</strong></span>  输入抄送人员的E-mail，用分号分隔开,只允许添加公司邮箱即以@airmacau.com.mo结尾的邮箱</p>
<p>例如:example1@airmacau.com.mo;example2@airmacau.com.mo</p>
