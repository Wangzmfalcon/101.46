<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ceritifcate_Monitor.aspx.cs" Inherits="Home" %>
...
<link href="css/leftmenu.css" rel="stylesheet" type="text/css" />
 ...
 <script src="js/leftmenu.js" type="text/javascript"></script>
   <script src="js/check.js" type="text/javascript"></script>
    ...
    <title>Ceritifcate_Monitor</title>
...
<div id="biaoti" style=" font-size:20px; text-align:center; color:Red">Ceritifcate Monitor<br />
    <br />
    </div>
<div style="width:800px; height=150px;font-size:14px; float:left;margin-left:100px">
...
<p>Enter the query information</p>
    Registration<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
<asp:Button ID="Button2" runat="server" Text="C_of_A/ASL" 
        onclick="Button2_Click" Width="120px" />
<asp:Button ID="Button3" runat="server" Text="Radio_Licence/C_of_A_IRL" onclick="Button3_Click" 
        style="width: 160px" />
<asp:Button ID="Button4" runat="server" Text="ASL_IRL/Declaration" onclick="Button4_Click" 
        style="width: 120px" />
    <asp:Button ID="Button5" runat="server" Text="C_of_R" onclick="Button5_Click" 
        style="width: 120px" />
...
<asp:GridView ID="GridView1" runat="server"  Width="1000px" AllowPaging="True"  GridLines="None" 
 OnRowCommand="GridView1_RowCommand"    OnPageIndexChanging="GridView1_PageIndexChanging"
  OnRowEditing="GridView1_RowEditing" 
      ...
      <PagerTemplate>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 第&nbsp;<asp:Label
                                    ID="Label2" runat="server" Text="<%#((GridView)Container.Parent.Parent).PageIndex + 1 %>"></asp:Label>&nbsp;页
