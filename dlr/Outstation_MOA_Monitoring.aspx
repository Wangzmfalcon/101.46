<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Outstation_MOA_Monitoring.aspx.cs" Inherits="Home" %>
...
<link href="css/leftmenu.css" rel="stylesheet" type="text/css" />
 ...
 <script src="js/leftmenu.js" type="text/javascript"></script>
   <script src="js/check.js" type="text/javascript"></script>
    ...
    <title>Outstation MOA Monitoring</title>
...
<div id="biaoti" style=" font-size:20px; text-align:center; color:Red">Outstation MOA Monitoring<asp:Label ID="Label5" runat="server"></asp:Label>
    <br />
    <br />
    </div>
...
<p>Enter the query information</p>
    Station<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
