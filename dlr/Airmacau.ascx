...
<div id="systitle">
    ...
    <div class="toptitle">ENM Deadline Reminder</div>
...
<div style="background: #324143; width: 1000px">
    <ul id="jsddm">
        ...
        <li><a href="changpassword.aspx">User service</a>
            <ul>
                <li><a href="changpassword.aspx">Change Password</a></li>
            </ul>
        </li>
        <li><a href="ENM_Staff_Master.aspx">Deadline List</a>
            <ul>
                <li><a href="ENM_Staff_Master.aspx">ENM Staff Master</a></li>
                <li><a href="Ceritifcate_Monitor.aspx">Ceritifcate Monitor</a></li>
                <li><a href="Finding_Control.aspx">Finding Control</a></li>
                <li><%--<a href="Outstation_MOA_Monitoring.aspx">MOA</a>--%></li>
            </ul>
        </li>
        <li><a href="ML.aspx" style="width: 90px;">Reminder Setting</a>
            <ul>
                <li><a href="ML.aspx">Email List</a></li>
                <li><a href="RS.aspx">Reminder Setting</a></li>
            </ul>
        </li>
