...
<asp:Button ID="Button2"
    runat="server" Text="modify" onclick="Button2_Click" /></li>
</ul>
</div>
...
<li>Station_Licence <asp:TextBox ID="TextBox4" runat="server">30</asp:TextBox>days
<asp:Button ID="Button4"
    runat="server" Text="modify" onclick="Button4_Click" /></li>
<li>Radio_Licence&nbsp;&nbsp; <asp:TextBox ID="TextBox7" runat="server">30</asp:TextBox>days
<asp:Button ID="Button7"
    runat="server" Text="modify" onclick="Button7_Click" /></li>
<li>Insurance&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBox8" runat="server">30</asp:TextBox>days
...
<ul>Finding_Control:
<li>Final_Issue_Date<asp:TextBox ID="TextBox5" runat="server">30</asp:TextBox>days
<asp:Button ID="Button5"
    runat="server" Text="modify" onclick="Button5_Click" /></li>
<li>Final_Due_Date&nbsp; <asp:TextBox ID="TextBox6" runat="server">30</asp:TextBox>days
