    ...
    public void saveExcel(string savepath,DataSet dstemp)
    {
        ...
        try
        {
            ...
            int sizeofsheet = sheets.Count;
                ...
                int countrow = dstemp.Tables[excelsheetname.ToString()].Rows.Count;
                var RowAll = worksheet.get_Range(worksheet.Cells[1, 1], worksheet.Cells[countrow+1,9 ]);
                RowAll.Borders.LineStyle = Microsoft.Office.Interop.Excel.XlLineStyle.xlContinuous;
                System.Data.DataTable table = dstemp.Tables[excelsheetname.ToString()];
