...
<link href="css/leftmenu.css" rel="stylesheet" type="text/css" />
 ...
 <script src="js/leftmenu.js" type="text/javascript"></script>
    ...
    <title>Department head meeting supervising list</title>
 ...
 <tr>
  ...
  <tr>
    <td width="350" style="padding:0 5px;height:30px" >
        ...
        <br />
        Before convert<br />
        </strong>&nbsp;<asp:Image ID="Image1" runat="server" ImageUrl="~/images/before.png" Height="197px" Width="832px" />
      </td>
</tr>
<tr>
    <td width="350" style="padding:0 5px;height:30px" >
        ...
        After convert<br />
            ...
            &nbsp;<asp:Image ID="Image3" runat="server" ImageUrl="~/images/after.png" />
     </td>
</tr>
