<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="Home" %>
...
<h1>1.Report</h1>
    <ul>
        <li>
        <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">Report1</asp:LinkButton>
        </li> 

         <li>
        <asp:LinkButton ID="LinkButton2" runat="server" onclick="LinkButton2_Click">Satisfaction</asp:LinkButton>
        </li>
        </ul>
</div>
...
<div id="copyright">
    Copyright © 2013 - All Rights Reserved Air Macau Company IT Division iv>
</div>
