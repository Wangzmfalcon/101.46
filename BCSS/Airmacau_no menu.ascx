<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Airmacau_no menu.ascx.cs" Inherits="WebUserControl" %>
 <!--css-->
...
<div class="toptitle">Business Class Service Survey</div><div class="version">V1.0</div>
</div>
