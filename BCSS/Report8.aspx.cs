...
public partial class Home : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if(flag)
        {
            ...
            string SQL_select =
             "select station as Station, SUM(BD.VAL_08),COUNT(BD.VAL_08), Convert(decimal(18,2),SUM(BD.VAL_08)*1.0/COUNT(BD.VAL_08)) Avg"
             + " from BCSS_DATE BD"
             + " where STATUS='NEW'"
             + " and BD.VAL_01<>0"
            ...
            if (dt.Rows.Count > 0)
            {
               ...
               // Chartlet1.Shadow.Radius = 3;
                Chartlet1.ChartTitle.Text = "Avg Satisfaction for Question8";
