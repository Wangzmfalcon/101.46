...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void login_Click(object sender, EventArgs e)
    {
        ...
        string SQL_Login =
            "select * from BCSS_USER where USER_ID =@userid COLLATE  Chinese_PRC_CS_AS  ";
            ...
            if (rdr.Read())
            {
                ...
                if (pwd == Session["User_PWD"].ToString())
                    ...
                    Response.Redirect("Home.aspx");
                        ...
                        ClientScript.RegisterStartupScript(GetType(), "message", "<script>alert('Your password has expired. Please contact administrator.');</script>");
