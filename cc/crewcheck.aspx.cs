...
public partial class crewcheck : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (DropDownList2.Text != "")
        {
            ...
            {
                Session["CC_Object"] = DropDownList2.Text;
            }
    ...
    protected void Bind()
    {
        ...
        string CC_S = Session["CC_StaffNo"].ToString().Trim();
        ...
        string SQL_Query = "select * from Crew_Check,Crew_Info"
            + " where Crew_Check.Rcd_Status='NEW' and Crew_Info.Rcd_Status='NEW' and Crew_Check.Staff_No = Crew_Info.Staff_No" + ccs + cct + cco + ccd + cce
