...
<div style=" height:60px; font-size:14px; font-style:normal;">
    Staff_No/Name:<%--<asp:DropDownList ID="DropDownList4" runat="server" Width="80px" Visible=false>
    </asp:DropDownList>--%>
    ...
    No_Object:<asp:DropDownList ID="DropDownList2" runat="server" Height="22px"  Width="70px">
</asp:DropDownList>    
