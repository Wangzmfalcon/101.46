...
public partial class Currency_Setting : System.Web.UI.Page
{
    ...
    protected void save_Click(object sender, EventArgs e)
    {
        ...
        //string Station_Text = Station.SelectedValue;
        ...
        //检查是否存在
        string SQL_query = " select * from ERS_Trans where Trans_Value='" + Currency_Type + "' and Trans_Station='" + Station.SelectedValue + "' and Trans_Type='Currency'";
    ...
    protected void delete_Click(object sender, EventArgs e)
    {
        ...
        string SQL_delete = " delete ERS_Trans where Trans_Value='" + Currency_Type + "' and Trans_Station='" + stationselect + "' and Trans_Type='Currency' ";
        using (SqlConnection conn = new SqlConnection(SqlHelper.Conn))
        {
